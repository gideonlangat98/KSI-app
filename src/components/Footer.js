      ...
      <footer className='mt-40 mb-10 border-solid border-2 border-pink-400 border-x-transparent 
        border-b-transparent mx-8'>
          <div className='flex justify-between'>
            <div className='ml-8 my-4'>
              <div className='flex place-content-center'>
                ...
                <div><h4 className='font-bold text-fuchsia-500 mb-3 text-center text-3xl'>KSI</h4></div>
              </div>
            ...
            <div>
              <h6 className='mt-6 text-white text-xl mr-4'>Important Links</h6>
            ...
            <div>
              <h6 className='mt-6 text-white text-xl mr-4'>Social Links</h6>
          ...
          <div className='flex place-content-center mt-10'>
            <div><img className=' mr-1' src='https://img.icons8.com/fluency-systems-regular/256/creative-commons-all-rights-reserved.png'
             alt='copyright' width='25' /></div>
            <div>
              <p className='font-bold text-fuchsia-500 tracking-wide'>Copyright@2023</p>
            </div>
          </div>
